...
export const createUserApi = async (userData) => {
  try {
    // Log userData to inspect its contents
    console.log("User data before addDoc:", userData);
    
    // Check for undefined fields
    if (!userData.password) {
      throw new Error("Password is undefined. Please check the input data.");
    }
    ...
    return null; // Optional: return null or a suitable fallback value if an error occurs
  }
};
